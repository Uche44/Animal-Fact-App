          ...
          <div className=" mt-5 w-full h-fit grid grid-cols-3 grid-rows-2 gap-1">
            {types
              ...
              .map((type, index) => (
                <button
                  key={index}
                  className="h-[2.5rem] w-100 text-amber-700 font-bold text-[18px] rounded-[10px] border-none hover:bg-amber-300 bg-amber-200 active:scale-90 transition-transform duration-150"
                  value={type}
                  onClick={handleClick}
                >
                  {type}
